...
[![](https://dcbadge.vercel.app/api/server/CXuRvvKt6m)](https://discord.gg/CXuRvvKt6m)


### Краткое введение в форматы файлов

##### Отличие между форматами игр  
В играх Глаз Дракона и Осада используются схожие форматы файлов. В Осаде добавлен немного упрощенные форматы для моделей и их анимаций.
...
0. Как распаковать и запаковать архивы игры .res?
...
2. Как открыть, изменить файлы .city, .dsc, .dat, .fir и другие?  
   Использовать скрипт для 010Editor ([ссылка](#010editor)).  .  
3. В каких файлах находятся модели и текстуры игры?
   Модели, текстуры, файлы анимации упакованы в архивы .res.
...
|  **2**  | [fmt_prs_res.py](plugins/noesis/fmt_prs_res.py)  | Распаковка/Запаковка архивов .res игр Глаз Дракона и Осада | Все архивы |
