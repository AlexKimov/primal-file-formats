...
Локации в игре разбиты на несколько файлов: LAND для геометрии (карта высот, лоды, данные для работы алгоритма оптимизации рендеринга карты высот ROAM), ETL текстуры и индексы для детализации текстур, LIGHT - изобржаения в формате JPEG (intel jpeg library), цветовая карта, SCBN - объекты на локации и другие.  
##### Другое 
