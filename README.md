...
|  **2**  | [light_tool](/tools/io/land_tool)  | Распаковка текстур из файла .light |
|  **3**  | [light_tool](/tools/io/land_tool)  | Парсер .ai файлов (квадродерево ноды для разбиения пространства) |
