...
В играх Глаз Дракона и Осада используются схожие форматы файлов, некоторые из которых различаются по структуре.  
Для текстур используются форматы DDS и TGA, которые хранятся в соотвествующих файлах, а также в файлах ETL хранятся текстуры в DDS формате.   
Модели в игре лежат в файлах MESH. Анимации для моделей в файлах ANM. Локации в игре разбиты на несколько файлов: LAND для геометрии, ETL для текстур и другие.  
